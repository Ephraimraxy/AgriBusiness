export const NIGERIAN_STATES = [
  ...
  export const STATES_LGAS: Record<string, string[]> = {
    ...
    benue: [
      ...
      'Oju', 'Okpokwu', 'Oturkpo', 'Tarka', 'Ukum', 'Ushongo', 'Vandeikya'
    ],
    borno: [
    ...
    imo: [
      ...
      'Nkwerre', 'Nwangele', 'Obowo', 'Oguta', 'Ohaji/Egbema', 'Okigwe', 'Onuimo', 'Orlu', 'Orsu', 'Oru East', 'Oru West', 'Owerri Municipal', 'Owerri North', 'Owerri West'
    ],
    jigawa: [
