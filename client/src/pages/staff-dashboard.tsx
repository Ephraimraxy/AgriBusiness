...
export default function StaffDashboardPage() {
  ...
  // Check for staff session on component mount
  useEffect(() => {
    ...
    setCurrentUserEmail(parsedStaff.email);
  }, [setLocation]);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="dashboard-layout flex-1">
        ...
        <main className="flex-1 p-6">
          {activeSection === "dashboard" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                                   <h2 className="text-3xl font-bold text-gray-800 mb-2">Staff Overview</h2>
                 <p className="text-lg text-gray-600">Manage your staff activities and administrative functions</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="card-shadow">
                  <CardHeader>
                     ...
                     <CardDescription className="text-base">Your staff details</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                                             <div className="flex justify-between">
                         <span className="text-base text-gray-600">Name:</span>
                         <span className="text-base font-medium">{currentStaff.firstName} {currentStaff.surname}</span>
                       </div>
                       <div className="flex justify-between">
                         <span className="text-base text-gray-600">Email:</span>
                         <span className="text-base font-medium">{currentStaff.email}</span>
                       </div>
                       <div className="flex justify-between">
                         <span className="text-base text-gray-600">Department:</span>
                         <span className="text-base font-medium">{currentStaff.department || 'Not specified'}</span>
                       </div>
                       <div className="flex justify-between">
                         <span className="text-base text-gray-600">Position:</span>
                         <span className="text-base font-medium">{currentStaff.position || 'Not specified'}</span>
                       </div>
                       <div className="flex justify-between">
                         <span className="text-base text-gray-600">Status:</span>
                         <Badge variant="outline" className="text-sm">
                           {currentStaff.isVerified ? 'Verified' : 'Pending'}
                         </Badge>
                       </div>
                    </div>
                  </CardContent>
                ...
                <Card className="card-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                         ...
                         onClick={() => setLocation("/staff-id-generation")}
                       >
                         <UserCheck className="mr-2 h-4 w-4" />
                         Manage Staff
                       </Button>
                       ...
                       <Button 
                         ...
                         size="default" 
                         className="w-full justify-start text-base"
                         onClick={() => setLocation("/original/trainee-registration")}
                       >
                       ...
                       <Button 
                         ...
                         size="default" 
                         className="w-full justify-start text-base"
                         onClick={() => setLocation("/original/resource-person-id-generation")}
                       >
                         <UserCheck className="mr-2 h-4 w-4" />
                         Manage RPs
                       </Button>
                ...
                <Card className="card-shadow">
                  <CardHeader>
                     ...
                     <CardDescription className="text-base">Administrative overview</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                                             <div className="flex items-center justify-between">
                         <span className="text-base text-gray-600">Total Staff:</span>
                       ...
                       <div className="flex items-center justify-between">
                         <span className="text-base text-gray-600">Total RPs:</span>
                         <span className="text-xl font-bold text-gray-800">0</span>
                       </div>
                       <div className="flex items-center justify-between">
          ...
          {/* Profile Section */}
          {activeSection === "profile" && currentStaff && currentUserEmail && (
            <ProfileManagement 
              userRole="staff" 
      ...
      <footer className="bg-gradient-to-r from-green-200 via-green-50 to-white text-gray-700 py-3 px-6 mt-auto border-t border-gray-200 shadow-sm">
        <div className="container mx-auto">
          <div className="flex items-center justify-center space-x-4">
            ...
            <span className="text-gray-500 text-xs">Staff Dashboard - Agricultural Training Management System</span>
          </div>
        </div>
      </footer>
