...
import { Button } from "@/components/ui/button.traineeview";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card.traineeview";
import { Input } from "@/components/ui/input.traineeview";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select.traineeview";
import { Badge } from "@/components/ui/badge.traineeview";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table.traineeview";
import { Checkbox } from "@/components/ui/checkbox.traineeview";
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from "@/components/ui/dialog.traineeview";
import { useToast } from "@/components/ui/use-toast.traineeview";
import { getTrainees, getRooms, getTagNumbers, deleteDocument, updateDocument, synchronizeAllocations, type Trainee, type Room, type TagNumber } from "@/lib/firebaseService.traineeview";
import { NIGERIAN_STATES, STATES_LGAS } from "@/lib/constants.traineeview";
